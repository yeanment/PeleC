module probdata_module
  ...
  double precision, save :: pamb, phi_in, T_in, vn_in, L(3), pertmag, T_inlet_pert_mag, T_inlet_pert_freq, P_inlet_pert_mag, P_inlet_pert_freq
  double precision, save, allocatable :: fuel_state(:)
  logical, save :: bc_initialized = .false.
  logical, save :: ipmf_on = .false.
