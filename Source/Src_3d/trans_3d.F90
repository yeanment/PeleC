    ...
    do j = jlo, jhi
       do i = ilo, ihi
          ...
          if (j >= jlo+1) then
             ...
             call reset_edge_state_thermo(qypo, qd_lo, qd_hi, i, j, kc, eos_state)
          ...
          if (j <= jhi-1) then
             ...
             call reset_edge_state_thermo(qymo, qd_lo, qd_hi, i, j+1, kc, eos_state)
  ...
  subroutine transx2( &
    ...
    do j = jlo, jhi
       do i = ilo, ihi
          ...
          call reset_edge_state_thermo(qzpo, qd_lo, qd_hi, i, j, kc, eos_state)
          ...
          call reset_edge_state_thermo(qzmo, qd_lo, qd_hi, i, j, kc, eos_state)
    ...
    do j = jlo, jhi
       do i = ilo, ihi
          ...
          if (i >= ilo+1) then
             ...
             call reset_edge_state_thermo(qxpo, qd_lo, qd_hi, i, j, kc, eos_state)
          ...
          if (i <= ihi-1) then
             ...
             call reset_edge_state_thermo(qxmo, qd_lo, qd_hi, i+1, j, kc, eos_state)
    ...
    do j = jlo, jhi
       do i = ilo, ihi
          ...
          if (i >= ilo+1) then
             ...
             call reset_edge_state_thermo(qxpo, qd_lo, qd_hi, i, j, km, eos_state)
          ...
          if (j >= jlo+1) then
             ...
             call reset_edge_state_thermo(qypo, qd_lo, qd_hi, i, j, km, eos_state)
          ...
          if (i <= ihi-1) then
             ...
             call reset_edge_state_thermo(qxmo, qd_lo, qd_hi, i+1, j, km, eos_state)
          ...
          if (j <= jhi-1) then
             ...
             call reset_edge_state_thermo(qymo, qd_lo, qd_hi, i, j+1, km, eos_state)
  ...
  subroutine transxy( &
    ...
    do j = jlo, jhi
       do i = ilo, ihi
          ...
          call reset_edge_state_thermo(qpo, qd_lo, qd_hi, i, j, kc, eos_state)
          ...
          call reset_edge_state_thermo(qmo, qd_lo, qd_hi, i, j, kc, eos_state)
    ...
    do j = jlo, jhi
       do i = ilo, ihi
          ...
          if (j >= jlo+1) then
             ...
             call reset_edge_state_thermo(qpo, qd_lo, qd_hi, i, j, km, eos_state)
          ...
          if (j <= jhi-1) then
             ...
             call reset_edge_state_thermo(qmo, qd_lo, qd_hi, i, j+1, km, eos_state)
    ...
    do j = jlo, jhi
       do i = ilo, ihi
          ...
          if (i <=ihi-1) then
             ...
             call reset_edge_state_thermo(qmo, qd_lo, qd_hi, i+1, j, km, eos_state)
