...
! :::
  ...
  subroutine consup( uin, uin_l1, uin_l2, uin_h1, uin_h2, &
    ...
    do n = 1, NVAR
       do j = lo(2), hi(2)
          do i = lo(1), hi(1)+1
             ...
             flux1(i,j,n) = flux1(i,j,n) * area1(i,j)
    ...
    do n = 1, NVAR
       do j = lo(2), hi(2)+1
          do i = lo(1), hi(1)
             ...
             flux2(i,j,n) = flux2(i,j,n) * area2(i,j)
    ...
    if (coord_type == 1) then
       ...
       ! (because the fluxes computed in the Riemann solver seem to not do this for cyl geom)
       do j = lo(2),hi(2)
          do i = lo(1),hi(1)+1
             flux1(i,j,UMX) = flux1(i,j,UMX) + area1(i,j) * q1(i,j,GDPRES)
          enddo
       enddo
